...
with open("c:/Users/Игорь/PycharmProjects/Books/Documentation/"
          "The_Python_Standard_Library/2. Built-in Functions/o-r/test2.txt") as f:
    print(f"{f.read()}\n")
...
# opens for read
with open("c:/Users/Игорь/PycharmProjects/Books/Documentation/"
          "The_Python_Standard_Library/2. Built-in Functions/o-r/test2.txt", mode='r') as f:
    print(f"{f.read()}\n")

# opens for write
with open("c:/Users/Игорь/PycharmProjects/Books/Documentation/"
          "The_Python_Standard_Library/2. Built-in Functions/o-r/test3.txt", mode = 'w') as f:
    f.write("string\n")
