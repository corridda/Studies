...
with dpg.window(width=300):
    ...
    print(f"dpg.get_value(input_txt1): {dpg.get_value(input_txt1)}")
    print(f"dpg.get_value(input_txt2): {dpg.get_value(input_txt2)}")
    print(f"dpg.get_value(slider_float1): {dpg.get_value(slider_float1)}")
    print(f"dpg.get_value(slider_float2): {dpg.get_value(slider_float2)}")
