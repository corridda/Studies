...
def main():
    message_1 = randbytes(randint(10, 30))
    message_2 = randbytes(randint(10, 30))
    ...
    # Encrypt message_2
    message_2_as_int = bytes_to_int(message_2)
    cipher_as_int_2 = simple_rsa_encrypt(message_2_as_int, public_key)

    # cipher_1 * cipher_2
    cipher_1_cipher_2_mult = (cipher_as_int_1 * cipher_as_int_2) % n

    # Decrypt cipher_1 * cipher_2
    cipher_1_cipher_2_mult_as_int = simple_rsa_decrypt(cipher_1_cipher_2_mult, private_key)

    # message_1 * message_2
    message_1_message_2_mult = (bytes_to_int(message_1) * bytes_to_int(message_2)) % n


    if cipher_1_cipher_2_mult_as_int != message_1_message_2_mult:
        print("[FAIL]")
    else:
        print("[PASS]")
